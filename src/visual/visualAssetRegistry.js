...
const ASSET_SETS = Object.freeze({
    ...
    // ?v=2 cache-busts: the static route in server.js sets
    ...
    'asset-codru-rose': Object.freeze({
        type: 'static-image',
        bottleUrl: '/visual-assets/bottle-codru-rose.png?v=2',
        fallbackUrl: '/visual-assets/bottle-fallback.svg',
    }),
    'asset-stefan-viorica': Object.freeze({
        type: 'static-image',
        bottleUrl: '/visual-assets/bottle-stefan-viorica.png?v=2',
        fallbackUrl: '/visual-assets/bottle-fallback.svg',
    }),
});
